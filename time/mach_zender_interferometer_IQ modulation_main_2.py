...
for ii in range(samplerate):
    ...
    E6_2out = mach_zender_interferometer_time_def.propagate1(IPB, IPB, E6_2in) # Delay for arm B. Actually only one path couple to fourth beam splitter
...
for ii in range(samplerate):
    ...
    E9_1in = np.array([[E8_out[0,0]], [0.25*Elosc_I[0,0]]])
    E9_2in = np.array([[E8_out[1,0]], [0.25*Elosc_Q[0,0]]])
