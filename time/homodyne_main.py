...
for ii in range(samplerate):
    ...
    Eout1 = mach_zender_interferometer_time_def.propagate1(wl, no, oplcommon1+signal, oplcommon2, Ein1)
    Ein2 = Eout1
    
    Eout2 = mach_zender_interferometer_time_def.beamsplitter(PT1, Ein2)
    Ein3 = Eout2
    
    Eout3 = mach_zender_interferometer_time_def.propagate1(wl, no, opl1, opl2, Ein3)
    Ein4 = Eout3    
